...
const CoursesSection: React.FC = () => {
  ...
  return (
    <section className="section-4 pt-4 sm:pt-6 md:pt-8 lg:pt-12 pb-6 sm:pb-8 md:pb-10 lg:pb-12 bg-white">
      <div className="container mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-12">
          {/* Mobile */}
          <div className="flex flex-col items-center md:hidden">
            <img src={UserIcon} alt="Icon User" className="mb-2" />
            <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#e92f05] to-[#f5af19]">
              +10.000{" "}
          ...
          <div className="hidden md:block">
            <h1 className="member-count text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#e92f05] to-[#f5af19] mb-2 flex items-center justify-center gap-2">
              <img src={UserIcon} alt="Icon User" /> +10.000{" "}
              <span className="text-gray-800 font-bold ml-1">Anggota</span>
            </h1>
