  ...
  return (
    <section className="section-2 pt-4 sm:pt-6 md:pt-8 lg:pt-12 pb-6 sm:pb-8 md:pb-10 lg:pb-12 bg-white">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-10 px-4 ">
        {/* Content (Teks selalu kiri) */}
        <div className="max-w-2xl flex-1 space-y-6 flex flex-col items-start text-left lg:items-start lg:text-left">
        ...
        {/* Image + Stats (selalu kanan) */}
        <div className="max-w-2xl lg:w-1/2 flex justify-center">
          <div className="image-stack relative max-w-[85%] sm:max-w-sm mx-auto">
            ...
            />
            <StatsCard />
            <div className="shadow-card orange-1 absolute top-2 left-2 w-full h-full rounded-xl opacity-40 -rotate-2 z-10"></div>
            <div className="shadow-card orange-2 absolute top-5 left-5 w-full h-full rounded-xl opacity-20 -rotate-2 z-0"></div>
          </div>
        </div>
      </div>
    </section>
